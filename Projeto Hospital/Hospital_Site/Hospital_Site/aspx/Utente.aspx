<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Utente.aspx.cs" Inherits="Hospital_Site.aspx.Utente" %>
...
<body>
	...
	<header style="margin: 0px">
		<div style="float: left; background-color: #fff; min-width: 77%; height: 60px">
		...
		<div style="float: left; background-color: #fff; min-width: 23%; height: 60px">
			<span style="top: 0%; position: absolute; float: right; right: 120px; margin-top: 10px;">
				<a href="">Hospital</a>
			</span>
			<span style="top: 0%; position: absolute; float: right; right: 60px; margin-top: 10px;">
				<a href="">Utente</a>
			</span><span style="top: 0%; position: absolute; float: right; right: 20px; margin-top: 10px;">
				<a href="">Sair</a>
			</span>
		</div>
	</header>
	<form id="form1" runat="server">
		<div class="div1">...</div>
		<div class="div2">news do utente, como consultas etc etc</div>
		<div class="div3">news do hospital</div>
	</form>
</body>
</html>
