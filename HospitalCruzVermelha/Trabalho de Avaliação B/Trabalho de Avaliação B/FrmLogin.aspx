<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="FrmLogin.aspx.cs" Inherits="Trabalho_de_Avaliação_B.FrmLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="row">
        <div class="col-xs-2 col-sm-2 col-md-1 col-lg-1 marcador"></div>
            <div class="col-xs-8 col-sm-8 col-md-10 col-lg-10 marcador" style="background-color:#bff3ff">
